...
title: ChatGPT для создания интерьеров
description: ИИ стремительно врывается во все области деятельности. Рассмотрим возможности ChatGPT на примере проекта маленькой квартиры.
tags: ["code", "html"]
time: 4
featured: false
timestamp: 2024-12-18T02:39:03+00:00
filename: 1_ai-aided-design
---
